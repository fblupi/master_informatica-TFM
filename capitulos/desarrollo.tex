...
\lstinputlisting[caption={\textit{script} para usar el filtro media de ITK en una imagen en VTK}, label=code:desarrollo/vtk-itk-filtro, style=C]{misc/vtk-itk-filtro.cpp}
...
\lstinputlisting[caption={Descripción de formato XML utilizado usando XML Schema}, label=code:xmlschema-rod, style=XML]{misc/xmlschema-rod.xml}
...
\lstinputlisting[caption={Ejemplo de ROD el formato XML descrito}, label=code:ejemplo-rod, style=XML]{misc/ejemplo-rod.xml}
