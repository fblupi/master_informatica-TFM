...
\begin{table}[H]
	\begin{center}
		\begin{tabular} {l|c|l}
			...
			\multicolumn{2}{l|}{Dependencias} & 4.6. \\ \noalign{\hrule height 1pt}
			\multicolumn{3}{l}{Pruebas de aceptación} \\ \hline
			\multicolumn{3}{p{12cm}}{ - El usuario selecciona y arrastra un punto y se actualiza la posición de este y el valor de la medida de la distancia entre ambos.} \\ \hline
		\end{tabular}
	\end{center}
